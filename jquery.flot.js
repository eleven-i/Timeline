...
/*
This version has been modified by Guru to reduce the size of the overlay canvas 
so that it does not sit over the left-hand Y axis and prevent you clicking
on tick-labels which are links.  

This is a known issue in Flot: https://github.com/flot/flot/issues/1321

This modification is specifically for the Timeline library.

Tom Young <tom.young@gurusystems.com> 2015
*/
...
(function ($) {
  ...
  function Plot(placeholder, data_, options_, plugins) {
    ...
    plot.resize = function () {
      ...
      overlay.resize(width - plotOffset.left, height);
    };
    ...
    function setupGrid() {
      ...
      if (showGrid) {
        ...
        // Shift the overlay so that it doesn't overlap the Y axis
        $(overlay.element).css({ left: plotOffset.left });
      }
    ...
    function drawOverlay() {
      ...
      octx.save();
      overlay.clear();
      octx.translate(0, plotOffset.top);
